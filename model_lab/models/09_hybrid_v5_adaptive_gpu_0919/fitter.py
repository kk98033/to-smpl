...
This is an isolated model-lab implementation.  It deliberately reuses the
validated v2 rotation math while removing repeated work that is invariant for
fixed betas.  It does not modify the production bridge.
"""
